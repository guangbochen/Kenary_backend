...
class TempConfigApiController extends \Controller
{
	...
	public function store()
  {
    ...
    try
    {
      ...
      return \TempConfig::amend($id, $input);
    }
    catch (Exception $e)
    {
      return JsonHandler::raiseError ($e->getMessage(), 404);
